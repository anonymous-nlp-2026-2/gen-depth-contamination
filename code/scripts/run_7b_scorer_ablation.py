#!/usr/bin/env python3
"""7B Scorer Ablation: Qwen2.5-7B vs Qwen2.5-1.5B as scorer on C4 depth chains.

Re-extracts 15D features for Pythia-1.4B and OLMo-1B C4 depth chains using
...
GENERATOR_DATA = {
    "pythia_c4": ROOT / "data_exp020_pythia_greedy",
    "olmo_c4":   ROOT / "data" / "olmo_c4_cont",
}

OUT_DATA_ROOT = ROOT / "data" / "exp_7b_scorer_ablation"
OUT_RESULTS   = ROOT / "results" / "exp_7b_scorer_ablation"
...
def main():
    ...
    log.info("=" * 60)
    log.info("Phase 1: Qwen2.5-1.5B-Instruct scorer")
    log.info("=" * 60)
    ...
    log.info("=" * 60)
    log.info("Phase 2: Qwen2.5-7B scorer")
    log.info("=" * 60)
    ...
    # ── Phase 3: summary ──────────────────────────────────────────────────
    log.info("=" * 60)
    log.info("SUMMARY: 7B Scorer Ablation")
    log.info("=" * 60)
    ...
    summary_lines = [
        "=" * 70,
        "7B Scorer Ablation — Comparison Table",
        "=" * 70,
        "",
