#!/usr/bin/env python3
"""
DeBERTa-v3-base upper-bound baseline for arXiv domain (Qwen-1.5B scorer).
...
DATA_DIR = ROOT / "data"
RESULTS_DIR = ROOT / "results" / "exp_deberta_arxiv"

EXPERIMENTS = {
    "arxiv_qwen1b5": DATA_DIR / "exp_024_arxiv",
}

OBD_MAP = {
    "arxiv_qwen1b5": ROOT / "results" / "exp_024_arxiv" / "pairwise_auc.json",
}
