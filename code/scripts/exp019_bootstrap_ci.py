...
DATA_DIR = Path("/root/autodl-tmp/gen-depth-contamination/data_exp019_mistral7b")
OUT_PATH = Path("/root/autodl-tmp/gen-depth-contamination/artifacts/exp019_bootstrap_ci.json")
N_BOOT = 10000
N_PERM = 10000
MAX_DEPTH = 5
SEED = 42
...
def main():
    ...
    output = {
        "experiment": "exp-019 Mistral-7B-Instruct continuation",
