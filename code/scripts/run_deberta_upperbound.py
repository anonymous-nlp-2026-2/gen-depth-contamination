#!/usr/bin/env python3
"""
DeBERTa-v3-base upper-bound baseline: 6-class ordinal depth classification.
...
DATA_DIR = ROOT / "data"
RESULTS_DIR = ROOT / "results" / "exp_deberta_upperbound"
...
def load_obd(name):
    p = ROOT / "results" / f"exp_{name}" / "pairwise_auc.json"
    if p.exists():
