...
OUT_PATH = Path("/root/autodl-tmp/gen-depth-contamination/artifacts/exp025_bootstrap_ci.json")
N_BOOT = 10000
N_PERM = 10000
MAX_DEPTH = 5
SEED = 42
...
def main():
    ...
    output = {
        "experiment": "exp-025 Pythia-1.4B arXiv continuation (domain x model interaction)",
