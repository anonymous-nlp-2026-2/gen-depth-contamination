...
DATA_PATH = Path("/root/autodl-tmp/gen-depth-contamination/data/exp_wiki_pythia/features.csv")
OUT_DIR = Path("/root/autodl-tmp/gen-depth-contamination/results/feature_importance_pythia")
...
def main():
    ...
    pdf_path = ART_DIR / "feature_importance_pythia_1.4b.pdf"
    make_barplot(res_0v1, res_1v2, pdf_path)

    tex_path = ART_DIR / "feature_importance_pythia_1.4b.tex"
