...
OUT_PATH = Path("/root/autodl-tmp/gen-depth-contamination/artifacts/exp018_bootstrap_ci.json")
N_BOOT = 10000
N_PERM = 10000
MAX_DEPTH = 5
SEED = 42
...
def main():
    ...
    output = {
        "experiment": "exp-018 LLaMA-3.1-8B continuation, scorer=Qwen2.5-1.5B base",
