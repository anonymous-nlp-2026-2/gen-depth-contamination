...
\centering
\small
\caption{Experimental configurations for depth-chain generation (six primary configurations).}
\label{tab:setup}
\vspace{2pt}
\begin{tabular}{llcc}
  \toprule
  ...
  \midrule
  Qwen-rw   & Qwen2.5-1.5B-Inst & Rewrite & 5{,}000 \\
  Qwen-cont & Qwen2.5-1.5B-Inst & Cont.   & 5{,}000 \\
  Qwen-base & Qwen2.5-1.5B      & Cont.   & 5{,}000 \\
  Pythia    & Pythia-1.4B        & Cont.   & 5{,}000 \\
  OLMo      & OLMo-1B           & Cont.   & 5{,}000 \\
  Qwen-7B   & Qwen2.5-7B        & Cont.   & 5{,}000 \\
  \bottomrule
\end{tabular}
\end{table}
...
OBD yields superior pairwise $\auc$ compared to ordinal logistic regression (mean 0.6099 vs.\ 0.4883 across three model families), whose low MAE stems from collapsing predictions toward central depths rather than improved discrimination (Appendix~\ref{sec:computation_cost}).
